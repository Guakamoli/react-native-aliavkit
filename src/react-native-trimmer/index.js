...
export default class Trimmer extends React.Component {
  ...
  render() {
    ...
    const actualScrubPosition = ((boundedScrubPosition / totalDuration) * trackWidth) + TRACK_PADDING_OFFSET + HANDLE_WIDTHS / 2 + SCRUBBER_WIDTHS / 2;
    ...
    return (
      <View style={styles.root}>
        ...
        >
          ...
          <Animated.View style={[
            styles.scrubberContainer, { left: actualScrubPosition },
            {
              transform: [
                { translateX: this.props.scrollAniRef }
              ]
            }
