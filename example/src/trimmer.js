	...
	return (
		...
		>
			...
			>
				<View>
					<View style={{
						width: '100%', height: 250, backgroundColor: '#f638dc', padding: 20
					}}
					/>
					{
						playling
					...
					<ScrollView style={{ width: '100%', height: '100%', backgroundColor: 'blue' }}>
						<View style={{
							width: '100%', height: 100, backgroundColor: '#f638dc', padding: 20
						}}
						/>
						<View style={{
							width: '100%', borderWidth: 2, borderColor: '#f638dc', padding: 20
						}}
						>
							<TextInput />
						</View>
