...
public class MusicChooser extends BaseChooser {
    ...
    private MusicVolumeChangeDialog.OnMusicVolumeCallback mMusicVolumeCallback;

    public void setOnMusicVolumeCallback(MusicVolumeChangeDialog.OnMusicVolumeCallback callback) {
        ...
        if (musicChooseView == null) {
            ...
            musicChooseView.setMusicSelectListener(new com.aliyun.svideo.music.music.MusicSelectListener() {
                ...
                public void onShowMusicVolume() {
                    MusicVolumeChangeDialog dialog = MusicVolumeChangeDialog.show(requireActivity());
                    dialog.setOnMusicVolumeCallback(mMusicVolumeCallback);
                }
