...
public class SharedPreferenceUtils {
    ...
    private static final String IS_QUEEN_MODE = "is_queen_mode";
    ...
    public static void setIsQueenMode(Context context, boolean isRaceMode) {
        SharedPreferences mySharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = mySharedPreferences.edit();
        editor.putBoolean(IS_QUEEN_MODE, isRaceMode);
        editor.commit();
    }

    public static boolean getIsQueenMode(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        boolean isRaceMode = sharedPreferences.getBoolean(IS_QUEEN_MODE, false);
        return isRaceMode;
    }
