 ...
 * 拍鸭：视频录制
 */
public class AlivcSvideoRecordActivity extends BaseAliActivity {
    ...
    private void initRecord() {
        ...
        if (mInputParam != null) {
            mVideoRecordView.setBitrate(mInputParam.getBitrate());
        ...
        mVideoRecordView.setBlessingData(mStrTitle,mStrContent);
    }
...
//                RecordCommon.copyRace(activity);
    ...
    private void getData() {
        ...
        int bitrate = intent.getIntExtra(AlivcRecordInputParam.INTENT_KEY_BITRATE, AlivcRecordInputParam.DEFAULT_VALUE_BITRATE);
    ...
    protected void onResume() {
        ...
        mVideoRecordView.setCompleteListener(new AliyunSVideoRecordView.OnFinishListener() {
            ...
            public void onComplete(final String path, int duration, int ratio) {
                ...
                //是否开启降噪
                intent.putExtra("mHasDeNoise", false);


                //提词器
                intent.putExtra("strTitle", mStrTitle);
                intent.putExtra("strContent", mStrContent);
    ...
    protected void onStop() {
        ...
        onActivityCloseAnim();
        if (isFinishing()) {
            if (mVideoRecordView != null && mVideoRecordView.getRecorderVideoPath() != null) {
                for (String videoPath : mVideoRecordView.getRecorderVideoPath()) {
                    FileUtils.deleteFileOnExit(videoPath);
                }
            }
        }
    }
...
//        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        }else if(requestCode == SETTING_PERMISSION_REQUEST_CODE){
    ...
    protected void onRestart() {
        super.onRestart();
        if (isCalling) {
            phoningToast = FixedToastUtils.show(getApplicationContext(), getResources().getString(R.string.alivc_recorder_record_tip_phone_state_calling));
        }
     ...
     */
    public static void startRecord(Activity context, AlivcRecordInputParam recordInputParam, String strTitle, String strContent, int requestCode) {
