...
public class Transcoder {
    ...
    public AlivcEditInputParam getInputParam() {
        if (mInputParam == null) {
    ...
    public void setInputParam(AlivcEditInputParam mInputParam) {
...
//            cropParam.setVideoCodec(VideoCodecs.H264_SOFT_FFMPEG);
            ...
            AlivcEditInputParam inputParam = getInputParam();
            //视频比特率  Mbps
            cropParam.setVideoBitrate(inputParam.getBitrate());
            //视频质量
            cropParam.setQuality(inputParam.getVideoQuality());
            //视频帧率
            cropParam.setFrameRate(inputParam.getFrameRate());
            cropParam.setGop(inputParam.getGop());
            cropParam.setCrf(inputParam.getCrf());
            //编解码方式
            cropParam.setVideoCodec(inputParam.getVideoCodec());
            return cropParam;
        }
        return null;
    }
