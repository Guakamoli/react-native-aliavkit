    ...
    private static void startDownload(final UpgradeBean upgradeBean) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(sContext, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                ...
                //进入到这里代表没有权限.
                ActivityCompat.requestPermissions((AppCompatActivity) sContext, new String[] {Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_WRITE_EXTERNAL_STORAGE_REQUEST_CODE);
