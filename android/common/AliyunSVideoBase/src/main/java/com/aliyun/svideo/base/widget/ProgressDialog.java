...
//        mProgress.setProgressTintList(ColorStateList.valueOf(Color.parseColor("#D07323")));
        mProgress.setProgressTintList(ColorStateList.valueOf(ContextCompat.getColor(getContext(), R.color.alivc_common_bg_cyan_light)));
        mProgress.setProgressTintMode(PorterDuff.Mode.SRC_ATOP);
