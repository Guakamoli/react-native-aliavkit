    ...
    private void initView() {
        ...
        mDefaultSettingView.setItemSelectedListener(new OnBeautyFaceItemSeletedListener() {
            ...
            public void onAdvancedSelected(int postion, BeautyLevel beautyLevel) {
                ...
                //美颜点击等级按钮
                if (isRaceMode) {
                    if (postion < BeautyRaceConstants.QUEEN_BEAUTY_MAP.size()) {
                        if (mParams != null) {
                            mParams.beautyBuffing = BeautyRaceConstants.QUEEN_BEAUTY_MAP.get(postion).beautyBuffing;
                            mParams.beautyRuddy = BeautyRaceConstants.QUEEN_BEAUTY_MAP.get(postion).beautyRuddy;
                            mParams.beautyBigEye = BeautyRaceConstants.QUEEN_BEAUTY_MAP.get(postion).beautyBigEye;
                            mParams.beautySlimFace = BeautyRaceConstants.QUEEN_BEAUTY_MAP.get(postion).beautySlimFace;
                            mParams.beautyWhite = BeautyRaceConstants.QUEEN_BEAUTY_MAP.get(postion).beautyWhite;
                        }
                    }
                } else {
