...
- (NSString *)title
{
    NSArray<AVMetadataItem *> *artists =
    [AVMetadataItem metadataItemsFromArray:self.commonMetadata withKey:AVMetadataCommonKeyTitle keySpace:AVMetadataKeySpaceCommon];
...
- (NSString *)artist {
    NSArray<AVMetadataItem *> *artists =
    [AVMetadataItem metadataItemsFromArray:self.commonMetadata withKey:AVMetadataCommonKeyArtist keySpace:AVMetadataKeySpaceCommon];
