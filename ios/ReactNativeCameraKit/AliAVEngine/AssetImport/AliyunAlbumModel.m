...
+ (instancetype)modelWithAsset:(PHAsset *)asset
                          type:(AliyunAssetModelMediaType)type
{
    ...
    NSInteger duration = type == AliyunAssetModelMediaTypeVideo ? round(asset.duration) : 0;
...
- (instancetype)initWithFetchResult:(PHFetchResult *)result
